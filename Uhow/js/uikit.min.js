...
! function(t, e) {
    ...
    function V(t) {
        return C(t) ? [t] : M(t) ? m.slice.call(t) : k(t) ? t.map(W).filter(Boolean) : _(t) ? t.toArray() : []
    }
    ...
    function Ut() {
        ...
        return o = ie(o), 1 < h.length && (i = h, h = function(t) {
            ...
            }(o, a, h)), l = Qt(l), s.split(" ").forEach(function(e) {
    ...
    le.reject = function(i) {
        ...
        return new le(function(i, t) {
            ...
            0 === s.length && i(n);
            for (var o = 0; o < s.length; o += 1) le.resolve(s[o]).then(e(o), t)
        })
    }, le.race = function(n) {
        return new le(function(t, e) {
            for (var i = 0; i < n.length; i += 1) le.resolve(n[i]).then(t, e)
        })
    };
    var ue = le.prototype;
    ...
    function ve(t, e) {
        return t = Ce(t), H(e) ? t.innerHTML : we(t.hasChildNodes() ? ge(t) : t, e)
    }
    ...
    function oi(t, e, u, c, d, i, n, r) {
        ...
        var p = ai(t),
            m = ai(e),
            g = m;
        if (pi(g, u, p, -1), pi(g, c, m, 1), d = gi(d, p.width, p.height), i = gi(i, m.width, m.height), d.x += i.x, d.y += i.y, g.left += d.x, g.top += d.y, n) {
            var o = [ai(R(t))];
    ...
    function hi(t, e) {
        var i = si(t),
            n = si(e || W(t).offsetParent || R(t).document.documentElement);
        return {
            top: i.top - n.top,
            left: i.left - n.left
        }
    ...
    function wi(t, e, i) {
        return void 0 === e && (e = "width"), void 0 === i && (i = window), B(t) ? +t : u(t, "vh") ? bi(ui(R(i)), t) : u(t, "vw") ? bi(ci(R(i)), t) : u(t, "%") ? bi(ai(i)[e], t) : j(t)
    }
    ...
    function Li(t, e) {
        ...
        var i = Wi(t),
            n = Bt(t).filter(function(t) {
                return t === i || e.test(Ve(t, "overflow")) && t.scrollHeight > si(t).height
            }).reverse();
        return n.length ? n : [i]
    }
    ...
    qi.util = Object.freeze({
            ...
            scrollParents: Li,
            getViewport: Fi
        }), qi.data = "__uikit__", qi.prefix = "uk-", qi.options = {}, qi.version = "3.2.6", Xi = (Yi = qi).data, Yi.use = function(t) {
        ...
        ln = {
            ...
            methods: {
                ...
                _toggleElement: function(t, e, i) {
                    ...
                    var r, o, s, a, h, l, u, c, d, f, p, m, g = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? (u = (l = this).isToggled, c = l.duration, d = l.initProps, f = l.hideProps, p = l.transition, m = l._toggle, function(t, e) {
                        var i = Ze.inProgress(t),
                            n = t.hasChildNodes ? j(Ve(t.firstElementChild, "marginTop")) + j(Ve(t.lastElementChild, "marginBottom")) : 0,
                            r = Wt(t) ? ui(t) + (i ? 0 : n) : 0;
                        Ze.cancel(t), u(t) || m(t, !0), ui(t, ""), xi.flush();
                        var o = ui(t) + (i ? 0 : n);
                        return ui(t, r), (e ? Ze.start(t, G({}, d, {
                            overflow: "hidden",
                            height: o
    ...
    var un, cn = {
        ...
        gn = {
            ...
            events: [{
                ...
                handler: function(t) {
                    var e = t.target;
                    this.$el === e ? (un = this.isActive() ? null : un, Kt(this.$el, "updatearia"), this.tracker.cancel()) : un = null === un && Yt(e, this.$el) && this.isToggled() ? this : un
                }
            }, {
                name: "updatearia",
                self: !0,
            ...
            methods: {
                show: function(t, e) {
                    ...
                    if (void 0 === t && (t = this.toggle), void 0 === e && (e = !0), this.isToggled() && t && this.toggle && t.$el !== this.toggle.$el && this.hide(!1), this.toggle = t, this.clearTimers(), !this.isActive()) {
                        if (un) {
                            if (e && un.isDelaying) return void(this.showTimer = setTimeout(this.show, 10));
                ...
                hide: function(t) {
                    ...
                    this.clearTimers(), this.isDelaying = vn(this.$el).some(function(t) {
        ...
        kn = {
            ...
            update: {
                read: function(t) {
                    ...
                    t.rows = $n(e), t.stacks = !t.rows.some(function(t) {
                        return 1 < t.length
                    })
                },
                write: function(t) {
        ...
        for (var e = [
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === n.offsetParent ? In(s[0]) : (r = In(n, !0), In(s[0], !0)), r.top >= a.bottom - 1 && r.top !== a.top) {
                        e.push([n]);
                        break
                    }
                    if (r.bottom > a.top) {
                    ...
                    padding: this.parallax && function(t, e, i) {
                        for (var n = 0, r = 0, o = 0, s = e.length - 1; 0 <= s; s--)
                            for (var a = n; a < e[s].length; a++) {
                                ...
                                r = Math.max(r, l), o = Math.max(o, l + (a % 2 ? t : t / 8)), n++
                            }
                        return o - r
                    }(this.parallax, r, h),
                    rows: r,
    ...
    var Tn = lt ? {
        ...
        En = {
            ...
            update: {
                read: function() {
                    return {
                        rows: (this.row ? $n(this.elements) : [this.elements]).map(An)
                    }
                },
                write: function(t) {
    ...
    function An(t) {
        ...
        return o && s && (Ve(t, "minHeight", ""), e = _n(t), n = e.heights, r = e.max), {
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    i = ui(window) - (Nn(document.documentElement) - Nn(this.$el)) - n || ""
                } else {
                    if (i = "calc(100vh", this.offsetTop) {
                        var r = si(this.$el).top;
                        i += 0 < r && r < ui(window) / 2 ? " - " + r + "px" : ""
                    }!0 === this.offsetBottom ? i += " - " + Nn(this.$el.nextElementSibling) + "px" : B(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (i += " - " + Nn(xt(this.offsetBottom, this.$el)) + "px"), i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
                    prev: e
    ...
    var Mn = {
            ...
            methods: {
                    ...
                    return function(i) {
                        ...
                        return function(t, e) {
                            e && b(t, "<symbol") && (t = function(t, e) {
                                if (!Pn[t]) {
                                    var i;
                                    for (Pn[t] = {}; i = Dn.exec(t);) Pn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                                    Dn.lastIndex = 0
                                }
                                return Pn[t][e]
                            }(t, e) || t);
                ...
                applyAttributes: function(i) {
                    ...
                    l && !h.some(function(t) {
                        return t
                    }) && (h = l.split(" ").slice(2)), h.forEach(function(t, e) {
        ...
        Fn = {
            ...
            methods: {
                getSvg: function() {
                    ...
                    }((t = this.icon, ut ? X(X(t, "left", "right"), "previous", "next") : t));
    ...
    var Yn = {
        ...
        connected: function() {
            er[this.cacheKey] ? Un(this.$el, er[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && Un(this.$el, function(t, e, i) {
                var n;
                i && (n = rt.ratio({
                    width: t,
                    height: e
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return Un(e.$el, tr(t), t.srcset, t.sizes), er[e.cacheKey] = tr(t), t
    ...
    var rr = {
        ...
        ar = {
            ...
            events: [{
                ...
                handler: function() {
                    var r = this;
                    ci(window) - ci(document) && this.overlay && Ve(document.body, "overflowY", "scroll"), ze(document.documentElement, this.clsPage), this.bgClose && Gt(this.$el, "hide", wn(document, "click", function(t) {
                        var e = t.defaultPrevented,
                            i = t.target,
                            n = K(sr);
                ...
                handler: function() {
                    var e = this;
                    sr.splice(sr.indexOf(this), 1), sr.length || Ve(document.body, "overflowY", ""), sr.some(function(t) {
    ...
    var lr = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Oe(this.panel, "uk-margin-auto-vertical") ? ze(this.$el, "uk-flex") : Ve(this.$el, "display", "block"), ui(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
    ...
    var ur = {
        ...
        cr = {
            ...
            beforeConnect: function() {
                ...
                this.dropbar = t && (xt(t, this.$el) || Ce("+ .uk-navbar-dropbar", this.$el) || Ce("<div></div>")), this.dropbar && (ze(this.dropbar, "uk-navbar-dropbar"), "slide" === this.dropbarMode && ze(this.dropbar, "uk-navbar-dropbar-slide"))
            },
            disconnected: function() {
            ...
            methods: {
                ...
                transitionTo: function(t, e) {
                    var i = this,
                        n = this.dropbar,
                        r = Wt(n) ? ui(n) : 0;
                    return Ve(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), ui(n, r), Ze.cancel([e, n]), se.all([Ze.start(n, {
                        height: t
    ...
    var pr = {
        ...
        vr = {
            ...
            update: [{
                write: function() {
                    this.hidden && Ve(qt(this.elements, ":not(." + this.inViewClass + ")"), "visibility", "hidden")
                }
            }, {
                read: function(t) {
                    var i = this;
        ...
        br = {
            ...
            update: [{
                read: function(t, e) {
                    ...
                    return this.top = Math.max(j(xr("top", this)), this.topOffset) - this.offset, this.bottom = n && n - i, this.inactive = !this.matchMedia, {
                        lastScroll: !1,
                        height: i,
                ...
                write: function(t, e) {
                    ...
                    var r = t.dir,
                        ...
                        l = t.visible,
                        u = performance.now();
                    if (!((t.lastScroll = a) < 0 || a === s || !l || this.disabled || this.showOnUp && "scroll" !== e || ((300 < u - n || r !== o) && (t.initScroll = a, t.initTimestamp = u), t.lastDir = r, this.showOnUp && Math.abs(t.initScroll - a) <= 30 && Math.abs(s - a) <= 10)))
    ...
    var yr = {
            ...
            update: function() {
                ...
                this.show(qt(t, "." + this.cls)[0] || t[this.active] || t[0]), this.swiping && Ve(this.connects, "touch-action", "pan-y pinch-zoom")
            },
            methods: {
                index: function() {
                ...
                show: function(t) {
                    for (var e, i, n = this, r = this.$el.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, l = me(t, r, s), u = 0; u < o; u++, l = (l + h + o) % o)
                        if (!Mt(this.toggles[l], ".uk-disabled *, .uk-disabled, [disabled]")) {
                            e = this.toggles[l], i = r[l];
                            break
                        }
                    i && s !== l && (De(r, this.cls), ze(i, this.cls), ot(this.toggles, "aria-expanded", !1), ot(e, "aria-expanded", !0), this.connects.forEach(function(t) {
        ...
        Ar = {
            ...
            methods: {
                animate: function(t) {
                    ...
                    t(), Ze.cancel(this.target), r.forEach(Ze.cancel), Cr(this.target), this.$update(this.target), xi.flush();
                    var s = ui(this.target),
                        a = (r = r.concat(Ot(this.target).filter(function(t) {
                            return !b(r, t)
                        }))).map(function(t, e) {
                            return !!(t.parentNode && e in o) && (o[e] ? Wt(t) ? Nr(t) : {
                                opacity: 0
                            } : {
                                opacity: Wt(t) ? 1 : 0
                            })
                    ...
                    return o = a.map(function(t, e) {
                        ...
                        }), Cr(n.target), n.$update(n.target), xi.flush()
                    }, et)
                }
            }
        };
        ...
        methods: {
            ...
            setState: function(l, t) {
                ...
                void 0 === t && (t = !0), l = G({
                    ...
                    sort: []
                }, l), Kt(this.$el, "beforeFilter", [this, l]);
                var c = this.children;
                this.toggles.forEach(function(t) {
                ...
                function e() {
                    var t, e, i = (t = l.filter, e = "", J(t, function(t) {
                        return e += t || ""
                    }), e);
                    ...
                    var n, r, o = l.sort,
                        ...
                        a = o[1];
                    if (s) {
                        var h = (n = s, r = a, G([], c).sort(function(t, e) {
    ...
    var jr = {
            ...
            methods: {
                start: function() {
                    ...
                    this.unbindMove = function() {
                        e(), t.unbindMove = null
                    }, Ut(window, "scroll", this.unbindMove), Ut(document, gt, this.end, !0), Ve(this.list, "userSelect", "none")
                },
                move: function(t) {
                    var e = this;
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            ...
                            }), (this.index === r && this.prevIndex !== r || h) && Kt(n[this.index], "itemshown", [this]), c && (this.prevIndex = r, this.index = s, d || Kt(l, "beforeitemhide", [this]), Kt(u, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), l, !d && u), c && (d || Kt(l, "itemhide", [this]), Kt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
        ...
        methods: {
            show: function(t, e) {
                ...
                if (void 0 === e && (e = !1), !this.dragging && this.length) {
                    ...
                    if (n[e ? "unshift" : "push"](t), !e && 1 < n.length) 2 === n.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== l) {
                            var u, c;
                            if (this.dir = (c = s, "next" === (u = t) ? 1 : "previous" === u ? -1 : u < c ? -1 : 1), this.prevIndex = s, this.index = h, a && Kt(a, "beforeitemhide", [this]), !Kt(l, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
                            var d = this._show(a, l, e).then(function() {
                                return a && Kt(a, "itemhidden", [i]), Kt(l, "itemshown", [i]), new se(function(t) {
                                    xi.write(function() {
                                        n.shift(), n.length ? i.show(n.shift(), !0) : i._transitioner = null, t()
                                    })
                                })
                            });
                            return a && Kt(a, "itemhide", [this]), Kt(l, "itemshow", [this]), d
                        }
                        o()
                    }
                }
            ...
            _getTransitioner: function(t, e, i, n) {
                return void 0 === t && (t = this.prevIndex), void 0 === e && (e = this.index), void 0 === i && (i = this.dir || 1), void 0 === n && (n = this.transitionOptions), new this.Transitioner(P(t) ? this.slides[t] : t, P(e) ? this.slides[e] : e, i * (ut ? -1 : 1), n)
            }
        }
    };
    ...
    var Vr = {
        ...
        Rr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = Lr.scale, De(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function(t) {
                ...
                handler: function(t, r) {
                    ...
                    if (this.setItem(r, "<span uk-spinner></span>"), e)
                        if ("image" === i || e.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) de(e).then(function(t) {
                        ...
                        var h = o[2],
                            l = function(t, e) {
                                return void 0 === t && (t = 640), void 0 === e && (e = 450), s.setItem(r, qr("https://www.youtube" + (o[1] || "") + ".com/embed/" + h, t, e, s.videoAutoplay))
                            };
                    ...
                    } else(o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && ce("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(e), {
                        responseType: "json",
                        withCredentials: !1
                    }).then(function(t) {
                        var e = t.response,
                            i = e.height,
                            n = e.width;
                        return s.setItem(r, qr("https://player.vimeo.com/video/" + o[2], n, i, s.videoAutoplay))
                    }, function() {
                        return s.setError(r)
                    })
                }
    ...
    var Gr = {},
        Kr = {
            ...
            created: function() {
                Gr[this.pos] || (Gr[this.pos] = we(this.$container, '<div class="uk-notification uk-notification-' + this.pos + '"></div>'));
            ...
            methods: {
                close: function(t) {
                    function e() {
                        Kt(i.$el, "close", [i]), ke(i.$el), Gr[i.pos].children.length || Ve(Gr[i.pos], "display", "none")
                    }
                    var i = this;
                        ...
                        switch (e) {
                            ...
                            case "borderColor":
                                ...
                                t[e] = "rgba(" + h.map(function(t, e) {
                                    return t += u * (l[e] - t), 3 === e ? j(t) : parseInt(t, 10)
                                }).join(",") + ")";
                                break;
                            case "blur":
    ...
    function io(t, e, i) {
        var n, r = oo(t, e);
        return i ? r - (n = t, si(e).width / 2 - si(n).width / 2) : Math.min(r, no(e))
    }
    ...
    var ho = {
            ...
            data: {
                ...
                Transitioner: function(r, n, o, t) {
                    var e = t.center,
                        ...
                        l = n ? io(n, a, e) : i + si(r).width * o * (ut ? -1 : 1);
                    return {
                        dir: o,
                        show: function(t, e, i) {
                            void 0 === e && (e = 0);
                        ...
                        translate: function(t) {
                            ...
                            Ve(a, "transform", Or(tt(e - e * t - l, -ro(a), si(a).width) * (ut ? -1 : 1), "px")), this.updateTranslates(), r && (t = tt(t, -1, 1), so(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
            ...
            computed: {
                ...
                finite: function(t) {
                    return t.finite || Math.ceil(ro(this.list)) < si(this.list).width + ao(this.list).reduce(function(t, e) {
                ...
                sets: function(t) {
                    ...
                    return !O(e = e && this.slides.reduce(function(t, e, i) {
                        ...
                        if (a < l + n && (!o.center && i > o.maxIndex && (i = o.maxIndex), !b(t, i))) {
                            var r = o.slides[i + 1];
                            o.center && r && n < h - si(r).width / 2 ? h -= n : (h = s, t.push(i), a = l + s + (o.center ? n / 2 : 0))
                        }
                        return l += n, t
                    }, [])) && e
                },
            ...
            methods: {
                init: function(t) {
                    ...
                    !r || n || 0 < i || Rt(e) || Yt(e, "." + this.clsNoDrag) || this.handle && !Yt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = G({
                        target: e,
                        index: pe(r)
                    }, this.pos), Ut(document, mt, this.move), Ut(document, gt, this.end), Ut(window, "scroll", this.scroll), this.threshold || this.start(t))
                },
                start: function(t) {
                    var e, i, n;
                    this.drag = (e = this.$container, i = this.placeholder, Ve(n = we(e, i.outerHTML.replace(/(^<)li|li(\/>$)/g, "$1div$2")), G({
                        ...
                        overflow: "hidden"
                    }, Ve(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), ui(n.firstElementChild, ui(i.firstElementChild)), n);
                    ...
                    G(this.origin, {
                        left: s - this.pos.x,
                        top: a - this.pos.y
                    }), ze(this.drag, this.clsDrag, this.clsCustom), ze(this.placeholder, this.clsPlaceholder), ze(this.$el.children, this.clsItem), ze(document.documentElement, this.clsDragState), Kt(this.$el, "start", [this, this.placeholder]), r = this.pos, fo = setInterval(function() {
                        var t = r.x,
                            a = r.y;
                ...
                insert: function(i, n) {
                    ...
                    function t() {
                        var t, e;
                        n ? !Yt(i, r.$el) || (e = n, (t = i).parentNode === e.parentNode && pe(t) > pe(e)) ? be(n, i) : xe(n, i) : we(r.$el, i)
                    }
            ...
            methods: {
                show: function() {
                    ...
                    !this.isActive() && this.title && (wo.forEach(function(t) {
                        return t.hide()
                    }), wo.push(this), this._unbind = Ut(document, gt, function(t) {
                ...
                hide: function() {
                    this.isActive() && !Mt(this.$el, "input:focus") && (wo.splice(wo.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), ot(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ke(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function() {
                    this.tooltip = we(this.container, '<div class="' + this.clsPos + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"), this.positionAt(this.tooltip, this.$el), this.origin = "y" === this.getAxis() ? vi(this.dir) + "-" + this.align : this.align + "-" + vi(this.dir), this.toggleElement(this.tooltip, !0)
                },
                isActive: function() {
                    return b(wo, this)
                }
    ...
    function Eo(t) {
        ...
        ("attributes" !== t.type ? function(t) {
            for (var e = t.addedNodes, i = t.removedNodes, n = 0; n < e.length; n++) _e(e[n], Io);
    ...
    return J(Ir, Ao), J(To, Ao), qi.use(function(r) {
        fe(function() {
            var e;
            ...
            Ut(document, "animationstart", function(t) {
                ...
                if (i && i(), ne(t)) {
                    ...
                    }), "touchstart" == pt && (Ve(document.body, "cursor", "pointer"), Gt(document, gt + " " + bt, function() {
                        return setTimeout(function() {
    ...
    }), Io = ($o = qi).connect, So = $o.disconnect, "MutationObserver" in window && xi.read(function() {
